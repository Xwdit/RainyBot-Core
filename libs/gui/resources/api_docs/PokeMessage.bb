...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa][url=api:PokeMessage]PokeMessage[/url][/color] ￿init￿ [color=gray]([/color] [color=#70bafa][url=godot:int]int[/url][/color] type [color=gray])[/color]

	基于指定的戳一戳类型来手动构造一个PokeMessage类的实例


	● [color=gray]static[/color] [color=#70bafa][url=api:PokeMessage]PokeMessage[/url][/color] ￿init_meta￿ [color=gray]([/color] [color=#70bafa][url=godot:Dictionary]Dictionary[/url][/color] dic [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_poke_type￿ [color=gray]([/color] [color=#70bafa][url=godot:int]int[/url][/color] type [color=gray])[/color]
