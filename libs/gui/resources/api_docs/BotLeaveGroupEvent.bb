...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa][url=api:BotLeaveGroupEvent]BotLeaveGroupEvent[/url][/color] ￿init_meta￿ [color=gray]([/color] [color=#70bafa][url=godot:Dictionary]Dictionary[/url][/color] dic, [color=#70bafa][url=godot:int]int[/url][/color] reason_type [color=gray])[/color]
