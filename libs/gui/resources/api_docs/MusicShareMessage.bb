...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa][url=api:MusicShareMessage]MusicShareMessage[/url][/color] ￿init_meta￿ [color=gray]([/color] [color=#70bafa][url=godot:Dictionary]Dictionary[/url][/color] dic [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_share_kind￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_share_title￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_share_summary￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_share_jump_url￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_share_picture_url￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_share_music_url￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_share_brief￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]
