...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=gray][hint=此方法调用时无需构造实例，可通过类名直接调用]static[/hint][/color] [color=#70bafa][url=api:ImageMessage]ImageMessage[/url][/color] ￿init￿ [color=gray]([/color] [color=#70bafa][url=godot:Image]Image[/url][/color] image [color=gray])[/color]

	基于图像实例缓存并手动构造一个ImageMessage类的实例


	● [color=gray][hint=此方法调用时无需构造实例，可通过类名直接调用]static[/hint][/color] [color=#70bafa][url=api:ImageMessage]ImageMessage[/url][/color] ￿init_gif￿ [color=gray]([/color] [color=#70bafa][url=api:GifImage]GifImage[/url][/color] gif_image [color=gray])[/color]

	基于Gif动图实例缓存并手动构造一个ImageMessage类的实例


	● [color=gray][hint=此方法调用时无需构造实例，可通过类名直接调用]static[/hint][/color] [color=#70bafa][url=api:ImageMessage]ImageMessage[/url][/color] ￿init_id￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] image_id [color=gray])[/color]

	基于指定的图像ID来手动构造一个ImageMessage类的实例


	● [color=gray][hint=此方法调用时无需构造实例，可通过类名直接调用]static[/hint][/color] [color=#70bafa][url=api:ImageMessage]ImageMessage[/url][/color] ￿init_url￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] image_url [color=gray])[/color]

	基于指定的URL地址来手动构造一个ImageMessage类的实例


	● [color=gray][hint=此方法调用时无需构造实例，可通过类名直接调用]static[/hint][/color] [color=#70bafa][url=api:ImageMessage]ImageMessage[/url][/color] ￿init_path￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] image_path [color=gray])[/color]

	基于指定的本地文件路径来手动构造一个ImageMessage类的实例


	● [color=gray][hint=此方法调用时无需构造实例，可通过类名直接调用]static[/hint][/color] [color=#70bafa][url=api:ImageMessage]ImageMessage[/url][/color] ￿init_base64￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] image_base64 [color=gray])[/color]

	基于指定的BASE64编码来手动构造一个ImageMessage类的实例


	● [color=gray][hint=此方法调用时无需构造实例，可通过类名直接调用]static[/hint][/color] [color=#70bafa][url=api:ImageMessage]ImageMessage[/url][/color] ￿init_meta￿ [color=gray]([/color] [color=#70bafa][url=godot:Dictionary]Dictionary[/url][/color] dic [color=gray])[/color]
