...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa][url=api:VoiceMessage]VoiceMessage[/url][/color] ￿convert_to_voice￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] path [color=gray])[/color]
