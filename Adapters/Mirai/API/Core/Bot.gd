...
static func get_friend_list()->MemberList:
	var _result:Dictionary = await MiraiAdapter.send_bot_request("friendList",null,null)
...
static func get_group_list()->GroupList:
	var _result:Dictionary = await MiraiAdapter.send_bot_request("groupList",null,null)
	var _arr:Array = _result["data"]
...
static func get_profile()->MemberProfile:
	var _result:Dictionary = await MiraiAdapter.send_bot_request("botProfile",null,null)
...
static func get_cache_message(msg_id:int)->CacheMessage:
	...
	var _result_dic:Dictionary = await MiraiAdapter.send_bot_request("messageFromId",null,_req_dic)
